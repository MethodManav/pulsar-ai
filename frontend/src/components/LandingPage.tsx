...
import { Github, Slack, Mail, Zap, GitBranch, Bell, ArrowRight, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Send notifications to Slack, Email, Discord, and Teams — all from one platform."
    },
    {
      icon: <GitBranch className="w-8 h-8" />,
      title: "Instant Build Alerts",
      description: "Get real-time updates on deployments, CI/CD pipelines, and repository activity."
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Custom Triggers",
      description: "Set intelligent rules for when and how you want to be notified."
    },
    {
      icon: <Bell className="w-8 h-8" />,
      title: "Smart Filtering",
      description: "Reduce noise with AI-powered filtering that only shows what matters."
    }
  ];

  const steps = [
    { number: "01", title: "Sign in with GitHub", description: "Connect your GitHub account in seconds" },
    { number: "02", title: "Connect Your Channels", description: "Link Slack, Email, or other communication tools" },
    { number: "03", title: "Get Real-Time Updates", description: "Receive instant notifications for builds and deployments" }
  ];

  const handleGitHubSignIn = () => {
    // Navigate to dashboard (in a real app, this would handle GitHub OAuth)
    navigate('/dashboard');
  };
            ...
            <div className="space-y-8">
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground max-w-lg">
                  Instant notifications to your Slack, Email, and beyond — stay in sync without the noise.
                </p>
              </motion.div>

              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
                <button onClick={handleGitHubSignIn} className="btn-hero group relative z-10">
              ...
              <motion.div variants={itemVariants} className="flex items-center space-x-6 text-sm text-muted-foreground">
                <div className="flex items-center space-x-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-secondary/50 rounded-lg p-4 border-l-4 border-electric-blue">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="font-semibold text-green-500">Build Successful</span>
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to stay informed about your development workflow
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <motion.div variants={itemVariants} className="mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              See It In <span className="bg-hero-gradient bg-clip-text text-transparent">Action</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Connect your GitHub repositories to Slack channels with our intuitive dashboard
            </p>
          </motion.div>

          <motion.div variants={itemVariants} className="glass-card p-8 max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm">github.com/user/awesome-project</span>
                  </div>
            ...
            <button onClick={handleGitHubSignIn} className="btn-hero w-full md:w-auto">
              <Github className="w-5 h-5 mr-2" />
              Start Building Now
            </button>
          </motion.div>
